...
<h2> Here are all the Auctions </h2>
<%
	...
	String str = "SELECT * from Auction where username  = '" + username + "'";
/* 	String str1 = "S * from Item I , Auction A where I.itemID = A.itemID; "; */
	ResultSet result = stmt.executeQuery(str);
	  out.print("<table>");
		...
		out.print("<td>");
		//print out column header
		out.print("Creator of that Auction");
		out.print("</td>");
		out.print("<td>");
		//print out column header
		out.print("Winner of that Auction");
		out.print("</td>");
		out.print("</tr>");
