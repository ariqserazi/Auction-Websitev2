...
<body>
	...
	<%} else {
		...
		try {
			...
			String str = "select au.ItemID, username, Amount_Earned from Auction au inner join (select ItemID, MAX(amount) as Amount_Earned from Bid group by ItemID) ba ON au.ItemID = ba.ItemID and au.winner <> \"null\" Order by Amount_Earned desc";
