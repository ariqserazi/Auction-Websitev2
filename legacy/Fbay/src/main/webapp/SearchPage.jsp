...
<%
	...
	String str = "SELECT A.ItemID, ItemName, Color, Brand, size, StartDate, EndDAte, countOfDays, Initial_Price, Bid_Increment, winner from Item I inner join Auction A on I.ItemID = A.ItemID";
